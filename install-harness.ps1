...
$copyMap = @(
    ...
    @{ Source = "templates\docs\codex\USER_JOB.md"; Target = "docs\codex\USER_JOB.md" },
    @{ Source = "templates\docs\codex\EVALUATORS.md"; Target = "docs\codex\EVALUATORS.md" },
    @{ Source = "templates\docs\codex\SHIP_ADMISSION.md"; Target = "docs\codex\SHIP_ADMISSION.md" },
    @{ Source = "templates\docs\codex\SHIP_SCORECARD.md"; Target = "docs\codex\SHIP_SCORECARD.md" },
    @{ Source = "templates\docs\codex\PRODUCT_USEFULNESS.md"; Target = "docs\codex\PRODUCT_USEFULNESS.md" },
