...
| 2 | PromptLab | not found in TSF registry, C:\TSF_INBOX, C:\Dev, or Codex output exact-name search | unavailable | BLOCKED | none | path resolution only |
| 3 | FitTrack | C:\Users\codex-agent\Documents\Codex\2026-06-10\build-a-polished-mvp-called-fittrack\outputs\fittrack (not a git repo) | no TSF registry entry; output/work folders are not git repos | BLOCKED | none | path resolution only |
