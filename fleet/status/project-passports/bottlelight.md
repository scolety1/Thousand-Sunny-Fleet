# Project Passport - Bottlelight

Generated by TSF Daily Driver Pack V1 from TSF-local sources only. Evidence only; not executable authority or approval.

## Project

- Project name: Bottlelight
- Status: archived
- Repo path if known from TSF registry: C:\Dev\cellar-beverage-list
- Plain-English purpose: Live Wine & Beverage List
