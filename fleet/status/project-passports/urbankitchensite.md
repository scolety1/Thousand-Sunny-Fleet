# Project Passport - UrbanKitchenSite

Generated by TSF Daily Driver Pack V1 from TSF-local sources only. Evidence only; not executable authority or approval.

## Project

- Project name: UrbanKitchenSite
- Status: archived
- Repo path if known from TSF registry: C:\Dev\cellar-urban-kitchen-site
- Plain-English purpose: Normal Restaurant Website
