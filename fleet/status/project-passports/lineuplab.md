# Project Passport - LineupLab

Generated by TSF Daily Driver Pack V1 from TSF-local sources only. Evidence only; not executable authority or approval.

## Project

- Project name: LineupLab
- Status: archived
- Repo path if known from TSF registry: C:\Dev\cellar-training-hub
- Plain-English purpose: Staff Training Hub
