# Project Passport - EventBook

Generated by TSF Daily Driver Pack V1 from TSF-local sources only. Evidence only; not executable authority or approval.

## Project

- Project name: EventBook
- Status: archived
- Repo path if known from TSF registry: C:\Dev\cellar-private-events
- Plain-English purpose: Private Events Intake
