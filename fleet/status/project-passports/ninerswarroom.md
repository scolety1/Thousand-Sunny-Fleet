# Project Passport - NinersWarRoom

Generated by TSF Daily Driver Pack V1 from TSF-local sources only. Evidence only; not executable authority or approval.

## Project

- Project name: NinersWarRoom
- Status: archived
- Repo path if known from TSF registry: C:\Dev\niners-war-room
- Plain-English purpose: TSF-registered full-stack-web using the real-product profile.
...
- TSF registry validation command: powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\codex-static-check.ps1
