...
- Convert one named task request into a bounded Codex work order.
...
Goal: Turn one task request from first-safe-task.md into a bounded implementation plan or patch.
