...
The second independent audit closed all three prior findings but rejected candidate `11e0b116afe150dccf82b4674bee45ae9ed59555` because its authoritative PASS-basis label still said 83 assertions while the proof and seal said 94. That RED audit is also preserved separately. Commit `f1a9fc6d64add5370067b90f2cae668bf55f342c` corrected the identity, added regression coverage, and passed a new 21-of-21 all-up run with a consistent 94-assertion basis.
