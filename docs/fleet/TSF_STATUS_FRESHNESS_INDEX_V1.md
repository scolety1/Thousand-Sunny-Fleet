...
| `docs/fleet/overnight-runner/TSF_PRODUCT_REPO_PILOT_CANDIDATE_SELECTION_PACKET_V0.md` | `CURRENT_CONTROL` | Candidate-selection packet for deciding whether TSF-local evidence supports a first read-only product-repo pilot candidate. | Product repo access by itself, PrivateLens work, archived reactivation, or replacing exact Tim approval. |
