...
Assert-True ($finalAcceptanceSource -match "186_ASSERTION_REAL_APP_SERVER_INTERRUPTION_AND_FRESH_EXACT_STOP_MISSION_REVISION_RECOVERY_PROOF") 'Final acceptance PASS basis records the exact current fresh-owner Stop and mission-revision real-proof assertion count'
Assert-True ($finalAcceptanceSource -notmatch "94_ASSERTION_REAL_APP_SERVER_INTERRUPTION_AND_NEW_RUN_RECOVERY_PROOF") 'Final acceptance rejects the stale universal exact-evidence real-proof assertion count'
