...
Invoke-AcceptanceCommand -Name 'hq_chokepoint' -File $powershell -Arguments ($psBase + @((Join-Path $PSScriptRoot 'run-tsf-hq-chokepoint-tests.ps1'))) | Out-Null
